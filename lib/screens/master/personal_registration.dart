...
class ScreenPersonalRegistration extends StatefulWidget {
  const ScreenPersonalRegistration({super.key});

  @override
  State<ScreenPersonalRegistration> createState() => _ScreenPersonalRegistrationState();
}

class _ScreenPersonalRegistrationState extends State<ScreenPersonalRegistration> {
